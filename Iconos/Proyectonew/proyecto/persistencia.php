...
function almacenar_usuario($usuario){
	if(!usuario instanceof usuario)
		return null;
	$sql = sprintf("insert into usuario (nombreu,correo,contrasenia,codigou) values('%s','%f')", $usuario->nombreu,$usuario->correo,$usuario->contrasenia,$usuario->codigou);
...
//persistencia recuperar_planetas
//function recuperar_usuarios(){
//	$usuarios=[];
	//$sql="select nombreu,correo from usuarios order by nombreu,,correo order by nombre "
//}
